...
class RAGProcessor:
    ...
    def __init__(self, api_key: Optional[str] = None) -> None:
        ...
        if not self.api_key:
            raise ValueError("Google API key is required. Set it as an environment variable or pass it directly.")
    ...
    def process_document(self, file: Optional[BinaryIO] = None, file_type: Optional[str] = None, 
        ...
        self.retrieval_chain = ConversationalRetrievalChain.from_llm(
            ...
            retriever=self.vector_store.as_retriever(
                ...
                search_kwargs={"k": 5, "fetch_k": 10}  # Retrieve more documents for better context
            ),
    ...
    def query(self, query: str, chat_history: Optional[List[Tuple[str, str]]] = None) -> Dict[str, Any]:
        """
        ...
        response = self.retrieval_chain({"question": query, "chat_history": chat_history})
